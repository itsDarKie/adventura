...
public class HerniPlan extends Observable{
    ...
    private void zalozProstoryHry() {
        ...
        Vec mec = new Vec("mec",true,"x.jpg");
        Vec brneni = new Vec("brneni",true,"x.jpg");
        Vec klic1 = new Vec("zlaty_klic",true,"x.jpg");
        Vec klic2 = new Vec("stribrny_klic",true,"x.jpg");
        Vec vino = new Vec("vino",true,"x.jpg");
        Vec sud = new Vec("sud",false,"x.jpg");
        Vec postel = new Vec("postel",false,"x.jpg");
        Vec kameny = new Vec("kameny",true,"x.jpg");
        Vec dvere = new Vec("dvere",false,"x.jpg");
